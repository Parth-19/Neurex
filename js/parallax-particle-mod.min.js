/*!
 * IN PARTICLE THEME, THIS SAME FILE NEEDS TO BE IN 2 LOCATIONS
 * 1. theme folder /assets/js/vendor/ and
 * 2. 'Particle Elementor Elements' plugin's assets/vendor/parallax/
 * 
 ...
 * !!! PARTICLE MOD v1.0.0
 *
 * added addClass("pa-project-content-mirror")
 * added addClass(h.className) // now you can use data-class-name="something" to pass a custom class to parallax-mirror
 * https://github.com/pixelcog/parallax.js/issues/44
 * added .addClass(h.className).addClass('skilltech-fallen-back') to iosFix and androidFix lines (before .css({ backgroundImage: "url(" + this.imageSrc + ")",) to add the custom class to the fallback image if falback is used
 * -- the skilltech-fallen-back is for extra styling control
 * last safe backup parallax-particle-mod.min-BEKAP2021-03-30.js
 */
!(function (t, i, e, s) {
    function o(i, e) {
        var h = this;
        ...
        if (
            ...
            return this.imageSrc && this.iosFix && !this.$element.is("img") && this.$element.addClass(h.className).addClass('skilltech-fallen-back').css({ backgroundImage: "url(" + this.imageSrc + ")", backgroundSize: "cover", backgroundPosition: this.position }), this;
        if (navigator.userAgent.match(/(Android)/))
            return this.imageSrc && this.androidFix && !this.$element.is("img") && this.$element.addClass(h.className).addClass('skilltech-fallen-back').css({ backgroundImage: "url(" + this.imageSrc + ")", backgroundSize: "cover", backgroundPosition: this.position }), this;
        this.$mirror = t("<div />").prependTo(this.mirrorContainer);
        var a = this.$element.find(">.parallax-slider"),
            n = !1;
        0 == a.length ? (this.$slider = t("<img />").prependTo(this.$mirror)) : ((this.$slider = a.prependTo(this.$mirror)), (n = !0)),
            this.$mirror.addClass("parallax-mirror").addClass("pa-project-content-mirror").addClass(h.className).css({ visibility: "hidden", zIndex: this.zIndex, position: "fixed", top: 0, left: 0, overflow: "hidden" }),
